...
class Frost:
    ...
    def find_weather_station(self, selected_station = 0):
        ...
        self.weather_station_distance = round(json["data"][0]["distance"],2)
    ...
    def get_time_series(self, time_interval = "2022-01-01/2023-01-01"):
        ...
        if r.status_code != 200:
            st.warning(f"Bytt stasjon! Finner ikke timeserie for intervallet: {time_interval}")
            st.stop()
        json = r.json() 
    ...
    def get_temperatures(self):
        selected_weather_station = st.slider("Velg stasjon", min_value=0, value=0, step=1, max_value=self.number_of_stations)
        self.find_weather_station(selected_station=selected_weather_station)
        self.get_time_series(time_interval= "2019-01-01/2020-01-01")
